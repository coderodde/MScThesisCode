...
public final class PCTDataGenerator3 {

    private final int order;
    private final DataGeneratingPCT3 pct;
    private final List<Character> characterList;
    private final Random random = new Random();
    
    public PCTDataGenerator3(int order, int alphabetSize, double beta) {
        this.order = order;
//        this.pct = new DataGeneratingPCT(order, alphabetSize, weights);
        this.pct = new DataGeneratingPCT3(order, alphabetSize, beta);
